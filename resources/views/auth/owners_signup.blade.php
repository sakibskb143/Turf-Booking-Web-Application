...
<style>
    ...
    .form-control { border-radius: 10px; padding: 0.75rem; border: 1px solid #dcdcdc; }
    .form-control:focus { border-color: #00b050; box-shadow: 0 0 0 0.15rem rgba(0,176,80,0.15); }
    ...
    .password-toggle .toggle-icon:hover { color: #00b050; }
    .btn-auth {
    ...
    .btn-auth:hover { background-color: #029545; }
    .terms { margin-top: 1rem; font-size: 0.9rem; color: #555; }
    .auth-footer { text-align: center; margin-top: 1rem; font-size: 0.9rem; }
    .auth-footer a { color: #00b050; font-weight: 600; text-decoration: none; }
...
<div class="container">
    <div class="auth-container">
            ...
            <div class="row g-3">
                ...
                <div class="col-12 password-toggle">
                    ...
                    <div class="position-relative">
                        <input type="password" name="password" id="password" class="form-control pe-5" placeholder="Create a password" required>
                ...
                <div class="col-12 password-toggle">
                    ...
                    <div class="position-relative">
                        <input type="password" name="password_confirmation" id="confirmPassword" class="form-control pe-5" placeholder="Confirm your password" required>
        ...
        <div class="auth-footer">
            <p>Already have an account? <a href="{{ route('owners.login') }}">Login here</a></p>
        </div>
    </div>
</div>
